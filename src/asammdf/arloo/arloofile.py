...
from .presetwidget import PresetWidget
...
from ..gui.dialogs.advanced_search import AdvancedSearch
from ..gui.dialogs.channel_group_info import ChannelGroupInfoDialog
from ..gui.dialogs.channel_info import ChannelInfoDialog
from ..gui.dialogs.gps_dialog import GPSDialog
from ..gui.dialogs.window_selection_dialog import WindowSelectionDialog
from ..gui.ui.file_widget import Ui_file_widget
...
from ..gui.widgets.attachment import Attachment
from ..gui.widgets.can_bus_trace import CANBusTrace
from ..gui.widgets.database_item import DatabaseItem
from ..gui.widgets.flexray_bus_trace import FlexRayBusTrace
from ..gui.widgets.gps import GPS
from ..gui.widgets.lin_bus_trace import LINBusTrace
from ..gui.widgets.mdi_area import get_functions, MdiAreaWidget, WithMDIArea
from ..gui.widgets.numeric import Numeric
from ..gui.widgets.plot import Plot
from ..gui.widgets.tabular import Tabular
from ..gui.widgets.tree import add_children
from ..gui.widgets.tree_item import TreeItem
...
class ArlooFileWidget(WithMDIArea, Ui_file_widget, QtWidgets.QWidget):
    ...
    def add_preset(self, event):
        ...
        if len(str_list) == 0:
            QMessageBox.information(None, "ERROR", "채널을 하나 이상 선택해 주세요")
            return
        ...
        if not ok:
            ...
            if not preset_name:
                ...
                if self.preset_widget.has_preset(preset_name):
                    ...
                    retry = False
                    self.preset_widget.rename_preset(preset_name, str_list)
        return retry
