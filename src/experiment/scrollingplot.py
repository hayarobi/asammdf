...
from PySide6.QtWidgets import QWidget, QMainWindow, QGridLayout, QApplication, QStyleFactory
...
class ScrollingTimestampPlot(QWidget):
    ...
    def plot_updater(self):
        ...
        elapsed = self.timestamp.msecsTo(QTime.currentTime())
        self.data.append({'x': elapsed, 'y': self.data_point})
